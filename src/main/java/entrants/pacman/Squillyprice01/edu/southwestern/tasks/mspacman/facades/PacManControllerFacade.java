...
public class PacManControllerFacade {
	...
	public entrants.pacman.Squillyprice01.oldpacman.controllers.NewPacManController oldP = null;
	 ...
	 */
	public PacManControllerFacade(entrants.pacman.Squillyprice01.oldpacman.controllers.NewPacManController p) {
		oldP = p;
	}
