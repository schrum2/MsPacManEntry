...
public class GhostControllerFacade {
	...
	entrants.pacman.Squillyprice01.oldpacman.controllers.NewGhostController oldG = null;
	 ...
	 */
	public GhostControllerFacade(entrants.pacman.Squillyprice01.oldpacman.controllers.NewGhostController g) {
		oldG = g;
	}
	 ...
	 */
	private int[] moveEnumToArray(EnumMap<entrants.pacman.Squillyprice01.oldpacman.game.Constants.GHOST, entrants.pacman.Squillyprice01.oldpacman.game.Constants.MOVE> moves) {
			int[] result = new int[CommonConstants.numActiveGhosts];
			for (Entry<entrants.pacman.Squillyprice01.oldpacman.game.Constants.GHOST, entrants.pacman.Squillyprice01.oldpacman.game.Constants.MOVE> e : moves.entrySet()) {
