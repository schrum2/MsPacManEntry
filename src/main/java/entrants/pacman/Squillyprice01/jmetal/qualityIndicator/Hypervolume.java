 ...
 * @version 1.0
 */
package entrants.pacman.Squillyprice01.jmetal.qualityIndicator;
...
public class Hypervolume {
	...
	public entrants.pacman.Squillyprice01.jmetal.qualityIndicator.util.MetricsUtil utils_;

	/**
	 * Constructor Creates a new instance of MultiDelta
	 */
	public Hypervolume() {
		utils_ = new entrants.pacman.Squillyprice01.jmetal.qualityIndicator.util.MetricsUtil();
	} // Hypervolume
