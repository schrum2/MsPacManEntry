 ...
 * @version 1.0
 */
package entrants.pacman.Squillyprice01.jmetal.qualityIndicator.util;

import java.io.*;
import java.util.*;

import entrants.pacman.Squillyprice01.jmetal.base.Solution;
import entrants.pacman.Squillyprice01.jmetal.base.SolutionSet;
import entrants.pacman.Squillyprice01.jmetal.util.NonDominatedSolutionList;
...
public class MetricsUtil {
	...
	public SolutionSet readNonDominatedSolutionSet(String path) {
		try {
			...
			System.out.println("entrants.pacman.Squillyprice01.jmetal.qualityIndicator.util.readNonDominatedSolutionSet: " + path);
			e.printStackTrace();
		}
		return null;
