package entrants.pacman.Spooky.edu.southwestern.networks;
...
import entrants.pacman.Spooky.edu.southwestern.evolution.genotypes.TWEANNGenotype.LinkGene;
...
import entrants.pacman.Spooky.edu.southwestern.util.graphics.GraphicsUtil;
import entrants.pacman.Spooky.edu.southwestern.util.graphics.Plot;
...
public class TWEANN implements Network {
	...
	public TWEANN(TWEANNGenotype g) {
		...
		for (LinkGene lg : g.links) {
			System.out.println("LINKGENE: " + lg);
			if (lg.isActive()) {
