 ...
 */
package entrants.pacman.Spooky.edu.southwestern.tasks.mspacman.objectives.fitnessassignment;
...
public interface FitnessToModeMap {
	...
	// Combines level with ghost score since there is low pressure to beat
	// levels otherwise
