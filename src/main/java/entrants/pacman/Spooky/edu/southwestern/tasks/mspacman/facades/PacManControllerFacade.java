...
public class PacManControllerFacade {
	...
	public entrants.pacman.Spooky.oldpacman.controllers.NewPacManController oldP = null;
	 ...
	 */
	public PacManControllerFacade(entrants.pacman.Spooky.oldpacman.controllers.NewPacManController p) {
		oldP = p;
	}
