package entrants.pacman.Spooky.edu.southwestern.tasks.mspacman.sensors;
...
public class VariableDirectionBlockLoadedInputOutputMediator extends BlockLoadedInputOutputMediator {
	...
	/**
	 * changes the sensor direction for each block in the sensor blocks
	 * arrayList
	 * 
	 * @param dir
	 */
	...
	@Override
	/**
	 * @return the number of outputs, which is just 1 because it is just the
	 *         preference for the currently checked direction
	 */
	public int numOut() {
