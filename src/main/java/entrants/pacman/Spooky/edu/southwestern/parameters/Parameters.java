package entrants.pacman.Spooky.edu.southwestern.parameters;
...
import entrants.pacman.Spooky.edu.southwestern.networks.hyperneat.CenteredSubstrateMapping;
import entrants.pacman.Spooky.edu.southwestern.tasks.mspacman.data.JunctionNodes;
import entrants.pacman.Spooky.edu.southwestern.tasks.mspacman.objectives.fitnessassignment.GhostsPillsMap;
import entrants.pacman.Spooky.edu.southwestern.util.stats.Average;
import entrants.pacman.Spooky.edu.southwestern.util.stats.Max;
import entrants.pacman.Spooky.oldpacman.controllers.examples.Legacy;
import entrants.pacman.Spooky.oldpacman.controllers.examples.StarterPacMan;
