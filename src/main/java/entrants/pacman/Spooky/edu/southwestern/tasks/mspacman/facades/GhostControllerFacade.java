...
public class GhostControllerFacade {
	...
	entrants.pacman.Spooky.oldpacman.controllers.NewGhostController oldG = null;
	 ...
	 */
	public GhostControllerFacade(entrants.pacman.Spooky.oldpacman.controllers.NewGhostController g) {
		oldG = g;
	}
	 ...
	 */
	private int[] moveEnumToArray(EnumMap<entrants.pacman.Spooky.oldpacman.game.Constants.GHOST, entrants.pacman.Spooky.oldpacman.game.Constants.MOVE> moves) {
			int[] result = new int[CommonConstants.numActiveGhosts];
			for (Entry<entrants.pacman.Spooky.oldpacman.game.Constants.GHOST, entrants.pacman.Spooky.oldpacman.game.Constants.MOVE> e : moves.entrySet()) {
