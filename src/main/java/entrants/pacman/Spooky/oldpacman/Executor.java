package entrants.pacman.Spooky.oldpacman;

import static entrants.pacman.Spooky.oldpacman.game.Constants.DELAY;
import static entrants.pacman.Spooky.oldpacman.game.Constants.INTERVAL_WAIT;
...
import entrants.pacman.Spooky.edu.southwestern.log.DeathLocationsLog;
...
import entrants.pacman.Spooky.edu.southwestern.tasks.mspacman.agentcontroller.pacman.StaticPacManController;
import entrants.pacman.Spooky.edu.southwestern.tasks.mspacman.data.ScentPath;
...
import entrants.pacman.Spooky.oldpacman.controllers.HumanController;
import entrants.pacman.Spooky.oldpacman.controllers.examples.Legacy;
import entrants.pacman.Spooky.oldpacman.game.Game;
import entrants.pacman.Spooky.oldpacman.game.GameView;
