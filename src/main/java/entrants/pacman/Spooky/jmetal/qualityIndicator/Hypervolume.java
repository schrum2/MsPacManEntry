 ...
 * @version 1.0
 */
package entrants.pacman.Spooky.jmetal.qualityIndicator;
...
public class Hypervolume {
	...
	public entrants.pacman.Spooky.jmetal.qualityIndicator.util.MetricsUtil utils_;

	/**
	 * Constructor Creates a new instance of MultiDelta
	 */
	public Hypervolume() {
		utils_ = new entrants.pacman.Spooky.jmetal.qualityIndicator.util.MetricsUtil();
	} // Hypervolume
