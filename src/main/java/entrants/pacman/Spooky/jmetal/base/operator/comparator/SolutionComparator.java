 ...
 * @version 1.0
 */
package entrants.pacman.Spooky.jmetal.base.operator.comparator;

import java.util.Comparator;

import entrants.pacman.Spooky.jmetal.base.Solution;
import entrants.pacman.Spooky.jmetal.util.Configuration;
import entrants.pacman.Spooky.jmetal.util.Distance;
import entrants.pacman.Spooky.jmetal.util.JMException;
