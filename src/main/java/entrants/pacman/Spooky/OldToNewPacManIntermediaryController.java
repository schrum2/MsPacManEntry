package entrants.pacman.Spooky;
...
import entrants.pacman.Spooky.edu.southwestern.MMNEAT.MMNEAT;
import entrants.pacman.Spooky.edu.southwestern.evolution.genotypes.*;
...
import entrants.pacman.Spooky.edu.southwestern.tasks.mspacman.agentcontroller.pacman.NNMsPacMan;
import entrants.pacman.Spooky.edu.southwestern.tasks.mspacman.facades.GameFacade;
import entrants.pacman.Spooky.oldpacman.controllers.*;
...
/**
 * a class that converts entrants.pacman.Spooky.oldpacman controller information into popacman controller information
 * @author pricew
 *
 */
public class OldToNewPacManIntermediaryController extends pacman.controllers.PacmanController implements Drawable {

	protected final entrants.pacman.Spooky.oldpacman.controllers.NewPacManController oldpacman;
...
//		TWEANNGenotype wtf = (TWEANNGenotype) Easy.load(file);
	...
	public OldToNewPacManIntermediaryController(entrants.pacman.Spooky.oldpacman.controllers.NewPacManController oldpacman) {
	...
	public MOVE getMove(Game game, long timeDue) {
		...
		//converts an action to an entrants.pacman.Spooky.oldpacman move to a popacman move to be returned
	...
	/**
	 * Takes an entrants.pacman.Spooky.oldpacman move and returns the equivalent popacman move
	 * @param move
	 * @return
	 * @throws NoSuchFieldException
	 * @author pricew
	 */
	public static pacman.game.Constants.MOVE moveConverterOldToPO(entrants.pacman.Spooky.oldpacman.game.Constants.MOVE move){
		switch(move) {
			case NEUTRAL:
