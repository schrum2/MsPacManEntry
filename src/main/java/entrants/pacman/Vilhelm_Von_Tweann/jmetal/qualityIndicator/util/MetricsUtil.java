 ...
 * @version 1.0
 */
package entrants.pacman.Vilhelm_Von_Tweann.jmetal.qualityIndicator.util;

import java.io.*;
import java.util.*;

import entrants.pacman.Vilhelm_Von_Tweann.jmetal.base.Solution;
import entrants.pacman.Vilhelm_Von_Tweann.jmetal.base.SolutionSet;
import entrants.pacman.Vilhelm_Von_Tweann.jmetal.util.NonDominatedSolutionList;
...
public class MetricsUtil {
	...
	public SolutionSet readNonDominatedSolutionSet(String path) {
		try {
			...
			System.out.println("entrants.pacman.Vilhelm_Von_Tweann.jmetal.qualityIndicator.util.readNonDominatedSolutionSet: " + path);
			e.printStackTrace();
		}
		return null;
