 ...
 * @version 1.0
 */
package entrants.pacman.Vilhelm_Von_Tweann.jmetal.qualityIndicator;
...
public class Hypervolume {
	...
	public entrants.pacman.Vilhelm_Von_Tweann.jmetal.qualityIndicator.util.MetricsUtil utils_;

	/**
	 * Constructor Creates a new instance of MultiDelta
	 */
	public Hypervolume() {
		utils_ = new entrants.pacman.Vilhelm_Von_Tweann.jmetal.qualityIndicator.util.MetricsUtil();
	} // Hypervolume
