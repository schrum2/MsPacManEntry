package entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.evolution.genotypes;
...
public class TWEANNGenotype implements NetworkGenotype<TWEANN> {
    ...
    public final int numModules() {
    	...
    	System.out.println(neuronsPerModule);
    	System.out.println(standardMultitask);
    	System.out.println(CommonConstants.ensembleModeMutation);
    ...
    public double twoModulesDistance(int m1, int m2) {
    	throw new UnsupportedOperationException("Not needed in Ms. Pac-Man entry");
//        if (numModules == 1) {
