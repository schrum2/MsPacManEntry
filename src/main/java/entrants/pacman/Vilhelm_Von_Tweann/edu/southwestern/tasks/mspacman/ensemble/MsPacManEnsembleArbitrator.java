...
public abstract class MsPacManEnsembleArbitrator {
	...
	/**
	 * Given the outputs of several different networks (or modes), decide one
	 * (Ms. Pac-Man) action to perform based on all of their preferences.
	 * 
	 * @param preferences
	 *            outputs of several networks and/or modes:
	 *            preferences[mode][direction]
