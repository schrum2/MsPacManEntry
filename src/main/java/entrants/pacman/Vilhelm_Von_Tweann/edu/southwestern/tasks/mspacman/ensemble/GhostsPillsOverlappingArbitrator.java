...
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.tasks.mspacman.sensors.blocks.PowerPillAvoidanceBlock;
...
public class GhostsPillsOverlappingArbitrator extends OverlappingArbitrator {
	...
	public boolean[] modesToConsider(GameFacade gf) {
		if (gf.anyIsEdible()) {
			// Even when ghosts are edible, it may be a good pill eating
			// opportunity
