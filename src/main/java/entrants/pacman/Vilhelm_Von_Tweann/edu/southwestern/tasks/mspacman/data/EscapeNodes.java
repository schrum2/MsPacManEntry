package entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.tasks.mspacman.data;
...
public class EscapeNodes extends NodeCollection {
	...
	public void updateNodes(GameFacade gs, int current, boolean draw) {
        assert current != -1 : "current is -1 in EscapeNodes.updatenodes()";
		...
		ArrayList<ArrayList<Integer>> ghostJunctionsToPacMan = new ArrayList<ArrayList<Integer>>(
				gs.getNumActiveGhosts());
