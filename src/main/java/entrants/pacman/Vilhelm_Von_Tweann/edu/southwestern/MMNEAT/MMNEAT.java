package entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.MMNEAT;
...
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.evolution.EvolutionaryHistory;
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.evolution.genotypes.CombinedGenotype;
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.evolution.genotypes.Genotype;
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.evolution.genotypes.TWEANNGenotype;
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.experiment.Experiment;
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.log.EvalLog;
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.log.MMNEATLog;
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.log.PerformanceLog;
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.networks.ActivationFunctions;
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.networks.TWEANN;
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.networks.hyperneat.Bottom1DSubstrateMapping;
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.networks.hyperneat.SubstrateArchitectureDefinition;
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.networks.hyperneat.SubstrateCoordinateMapping;
...
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.scores.Score;
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.tasks.mspacman.ensemble.MsPacManEnsembleArbitrator;
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.tasks.mspacman.init.MsPacManInitialization;
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.tasks.mspacman.multitask.MsPacManModeSelector;
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.tasks.mspacman.sensors.MsPacManControllerInputOutputMediator;
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.tasks.mspacman.sensors.VariableDirectionBlockLoadedInputOutputMediator;
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.tasks.mspacman.sensors.directional.VariableDirectionBlock;
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.util.ClassCreation;
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.util.file.FileUtilities;
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.util.graphics.DrawingPanel;
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.util.random.RandomGenerator;
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.util.random.RandomNumbers;
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.util.stats.Statistic;
import entrants.pacman.Vilhelm_Von_Tweann.oldpacman.Executor;
...
//				if (multitaskNet != null && !multitaskNet.isEmpty()) {
					...
					//TODO
//					TWEANNGenotype wtf = (TWEANNGenotype) Easy.load("bestPacMan.xml");
...
//					}
					...
					System.out.println(pacmanInputOutputMediator.numIn());
					System.out.println(MMNEAT.sharedMultitaskNetwork);
					//MMNEAT.sharedMultitaskNetwork.numModules = 3;
					System.out.println(MMNEAT.sharedMultitaskNetwork.numModules);
...
//				Parameters.parameters.integerParameter("maxGens"), Parameters.parameters.stringParameter("base"));
	...
	public static void main(String[] args) throws FileNotFoundException, NoSuchMethodException {
		...
		//args = new String[]{"runNumber:1", "randomSeed:0", "base:tetris", "logPerformance:false", "logTWEANNData:false", "trials:1", "maxGens:300", "mu:50", "io:true", "netio:true", "mating:true", "task:entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.tasks.rlglue.tetris.TetrisTask", "rlGlueEnvironment:org.rlcommunity.environments.tetris.Tetris", "rlGlueExtractor:entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.tasks.rlglue.featureextractors.tetris.RawTetrisStateExtractor", "tetrisTimeSteps:true", "tetrisBlocksOnScreen:false", "rlGlueAgent:entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.tasks.rlglue.tetris.TetrisAfterStateAgent", "splitRawTetrisInputs:true", "senseHolesDifferently:true", "log:Tetris-moRawHNSeedFixedSplitInputs", "saveTo:moRawHNSeedFixedSplitInputs", "hyperNEATSeedTask:entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.tasks.rlglue.tetris.HyperNEATTetrisTask", "substrateMapping:entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.networks.hyperneat.BottomSubstrateMapping", "HNTTetrisProcessDepth:1", "netLinkRate:0.0", "netSpliceRate:0.0", "linkExpressionThreshold:-1"};
