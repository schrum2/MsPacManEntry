...
import entrants.pacman.Vilhelm_Von_Tweann.edu.southwestern.tasks.mspacman.sensors.directional.counts.VariableDirectionKStepCountBlock;
...
public abstract class DirectionalStaticLookAheadBlock extends MsPacManSensorBlock {
	...
	public double getCountValue(GameFacade gf, int dir, int[] targets) {
		...
		double count = VariableDirectionKStepCountBlock.countMembersAlongPath(gf, visited, targets, currentLocation,
				next, stepCount, max);
