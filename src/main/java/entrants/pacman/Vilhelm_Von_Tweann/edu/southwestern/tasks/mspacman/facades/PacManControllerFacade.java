...
public class PacManControllerFacade {
	...
	public entrants.pacman.Vilhelm_Von_Tweann.oldpacman.controllers.NewPacManController oldP = null;
	 ...
	 */
	public PacManControllerFacade(entrants.pacman.Vilhelm_Von_Tweann.oldpacman.controllers.NewPacManController p) {
		oldP = p;
	}
