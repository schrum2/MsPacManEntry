...
public final class NearestPillPacManVS extends Controller<MOVE> {
	...
	public MOVE getMove(Game game, long timeDue) {
		...
		// add lines to the ghosts (if not in lair) - green if edible, red
		// otherwise
		...
		// add the path AND ghost path from Ghost 0 to the first power pill (to
